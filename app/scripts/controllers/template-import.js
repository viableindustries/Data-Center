...
angular.module('commonsCloudAdminApp')
  .controller('TemplateImportCtrl', ['$rootScope', '$routeParams', '$scope', 'Application', 'Template', '$location', function ($rootScope, $routeParams, $scope, Application, Template, $location) {
